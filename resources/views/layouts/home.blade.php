...
@section('content')
    ...
    <div class="cards">
        <a class="card acc1" href="{{ url('website') }}">
            ...
            <div class="count" id="count-wa">—</div>
            <div class="muted">Renewals: <span id="renewal-wa">0</span></div>
        ...
        <a class="card acc2" href="{{ url('products') }}">
            ...
            <div class="muted">
                School Management, Billing Software, WhatsApp API
            </div>
            <div class="count" id="count-products">—</div>
            <div class="muted">Renewals: <span id="renewal-products">0</span></div>
            <div class="tag">Open</div>
        </a>
        ...
        <a class="card acc3" href="{{ url('digital-marketing') }}">
            ...
            <div class="count" id="count-dm">—</div>
            <div class="muted">Renewals: <span id="renewal-dm">0</span></div>
            <div class="tag">Open</div>
        </a>
        ...
        <a class="card acc4" href="{{ url('graphics') }}">
            ...
            <div class="count" id="count-graphics">—</div>
            <div class="muted">Renewals: <span id="renewal-graphics">0</span></div>
            <div class="tag">Open</div>
        </a>
        ...
        <a class="card acc1" href="{{ url('renewal') }}">
            ...
            <div class="count" id="count-renewal">—</div>
            <div class="muted">Overdue: <span id="renewal-overdue">0</span></div>
            <div class="tag">Open</div>
        </a>
        ...
        <a class="card acc2" href="{{ url('account-billing') }}">
            ...
            <div class="count" id="count-account-billing">—</div>
        ...
        <a class="card acc3" href="{{ url('hosting-servers') }}">
            ...
            <div class="count" id="count-hosting-servers">—</div>
            <div class="tag">Coming Soon</div>
        </a>
        ...
        <a class="card acc4" href="{{ url('special-features') }}">
            ...
            <div class="count" id="count-special-features">—</div>
            <div class="tag">Coming Soon</div>
        </a>
    </div>
@endsection
