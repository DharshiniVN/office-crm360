...
<a href="{{ url('/special-features') }}"><span>📁</span><span class="text">Special Features</span></a>
    ...
    <main class="content">
      <div class="topbar">
        ...
        <div class="h1">Proforma Invoice Management</div>
        <div class="actions">
          <button class="btn" onclick="window.location.href='../account-billing/index.html'">Back</button>
          <button class="btn primary" id="new-proforma-btn">+ New Proforma Invoice</button>
        </div>
      </div>
      ...
      <div id="proforma-form-container" style="display:none; margin-top: 20px;">
        <!-- Proforma invoice form will be injected here by JS -->
      </div>
      <div id="proforma-display-container" style="display:none; margin-top: 20px;">
        <!-- Rendered proforma invoice will be shown here -->
      </div>
      <div class="cards" id="proforma-cards" style="margin-top: 20px;">
        <!-- saved proforma invoices table will be injected by JS -->
      </div>
    </main>
  </div>
  <script src="{{ asset('dashboard-ui/js/app.js') }}"></script>
<script src="{{ asset('dashboard-ui/js/proforma-invoice.js') }}"></script>
</body>
</html>
