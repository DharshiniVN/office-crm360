    ...
    <main class="content">
      ...
      <div class="cards" style="grid-template-columns: repeat(3, 1fr); margin-bottom: 20px;">
        <div class="card" style="background: linear-gradient(90deg, #a1c4fd, #c2e9fb);">
          ...
          <div class="count" style="font-size: 32px; font-weight: 900;">$250,000</div>
        </div>
        <div class="card" style="background: #fde3b9;">
          <div class="label">Pending Payments</div>
          <div id="pending-payments-count" class="count" style="font-size: 32px; font-weight: 900;">8</div>
        </div>
      ...
      <div style="display: flex; gap: 40px; margin-bottom: 30px;">
        <div style="flex: 1; background: #fff; border-radius: 16px; box-shadow: 0 8px 24px rgba(0,0,0,.08); padding: 20px;">
          <h3 style="margin-top: 0; margin-bottom: 12px;">Revenue vs. Expenses</h3>
          <canvas id="revenueExpensesChart" height="200"></canvas>
        </div>
        <div style="flex: 1; background: #fff; border-radius: 16px; box-shadow: 0 8px 24px rgba(0,0,0,.08); padding: 20px;">
          <h3 style="margin-top: 0; margin-bottom: 12px;">Invoice Status</h3>
          <canvas id="invoiceStatusChart" height="200"></canvas>
          <div style="display: flex; justify-content: space-around; margin-top: 12px;">
            <div><span style="display:inline-block; width: 12px; height: 12px; background: #2563eb; border-radius: 50%; margin-right: 6px;"></span>Paid</div>
            ...
            <div><span style="display:inline-block; width: 12px; height: 12px; background: #10b981; border-radius: 50%; margin-right: 6px;"></span>Overdue</div>
          </div>
        </div>
      </div>

      <div style="display: flex; justify-content: center; gap: 20px;">
        <button class="btn ghost">PDF</button>
        <button class="btn ghost">Excel</button>
